...
# print(f"Pi = {np.pi}")
plt.subplot(141), plt.imshow(image, "gray"), plt.title("image")
plt.subplot(142), plt.imshow(np.log(1+np.abs(k_space)), "gray"), plt.title("K space (Decentralized)")
plt.subplot(143), plt.imshow(np.log(1+np.abs(abs(img_c3))), "gray"), plt.title("centralized")
plt.subplot(144), plt.imshow(abs(img_c4), "gray"), plt.title("reconstructed image")
#
plt.show()